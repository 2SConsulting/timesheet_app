  ...
  <div className="card">
    <div className="content">
      ...
      <form className="form-horizontal">
        ...
        <div className="form-group">
          <label className="control-label col-md-3">IHS Service Line</label>
          <div className="col-md-6">
            <Field
              name="placeholder"
              type="text"
        ...
        <div className="form-group">
          <label className="control-label col-md-3">Speciality</label>
          <div className="col-md-6">
            <Field
              name="placeholder"
              type="text"
        ...
        <div className="form-group">
          <label className="control-label col-md-3">Search Term</label>
          <div className="col-md-6">
            <Field
              name="placeholder"
              type="text"
