...
// Primary
export const lightBlue = '#144D87'; //'#3c8dbc';
// Danger
...
// Light sidebar
export const sidebarLightBg = '#144D87'; //'#f9fafc';
export const sidebarLightHoverBg = '#71C5E9'; //tinycolor('#f0f0f1').lighten(1.5).toString();
export const sidebarLightColor = '#fff'; //'#444';
export const sidebarLightHoverColor = '#fff';
export const sidebarLightSubmenuBg = sidebarLightHoverBg;
export const sidebarLightSubmenuColor = '#fff'; //'#777';
export const sidebarLightSubmenuHoverColor = '#fff';
